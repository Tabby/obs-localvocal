...
elseif(WIN32)
  ...
  #set(Whispercpp_Build_GIT_TAG "c10db6ea2883a4f77440fa8caeb296a0e351a58c")
  set(Whispercpp_Build_GIT_TAG "7395c70a748753e3800b63e3422a2b558a097c80")
  set(WHISPER_EXTRA_CXX_FLAGS "-fPIC")

  if(USE_SYSTEM_CUDA)
    set(ARCH_PREFIX "cuda${CUDA_VERSION}")
    add_compile_definitions("LOCALVOCAL_WITH_CUDA")
    set(WHISPER_ADDITIONAL_CMAKE_ARGS -DWHISPER_CUDA=ON)
  else() #($ENV{CPU_OR_CUDA} STREQUAL "cpu")
    add_compile_definitions("LOCALVOCAL_WITH_CPU")
  endif()
  ...
  ExternalProject_Add(
    ...
    CONFIGURE_COMMAND
      ...
      -DCMAKE_CUDA_FLAGS=${WHISPER_EXTRA_CXX_FLAGS}
